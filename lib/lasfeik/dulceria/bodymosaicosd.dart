...
import 'detalles_screend.dart';

class bodymosaicosd extends StatelessWidget{
  @override
          ...
          child:Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) =>
                productos(product: productsd[index],
                press: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => detalles_screend(
                      product: productsd[index],
                    ),
                  )
                ),
              ),
