...
import 'detalles_screens.dart';

class bodymosaicose extends StatelessWidget{
  @override
          ...
          child:Padding(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) =>
                productos(product: productsss[index],
                press: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => detalles_screens(
                      product: productsss[index],
                    ),
                  )
                ),
              ),
