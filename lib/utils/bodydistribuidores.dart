...
import 'package:ejercicio/widgets/row_with_card.dart';
import 'package:ejercicio/widgets/row.dart';
import 'package:flutter/material.dart';

class bodydistribuidores extends StatelessWidget{
  @override
  Widget build(BuildContext context){

    List<String> category = List();
    category.add("Bebidas");
    category.add("Despensa");
    category.add("Dulceria");
    category.add("Higiene");
    category.add("Pan");
